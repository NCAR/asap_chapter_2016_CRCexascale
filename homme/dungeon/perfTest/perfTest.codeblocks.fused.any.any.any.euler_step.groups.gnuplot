...
set border 1
set xlabel "Time (ms)";
set title "Instance groups for Appl * Task * Thread * - Region euler_step\n8640 Instances - No instance grouping"
...
set label "" at 2576471.0/1000000.0,0 point lt 1 ps 2 lc rgb "#FF0000";

plot \
'perfTest.codeblocks.fused.any.any.any.groups.csv' using (strcol(1) eq 'u' && (strcol(2) eq 'euler_step' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 ti 'Group_0 (5744/2896)' w points ls 1,\
'perfTest.codeblocks.fused.any.any.any.groups.csv' using ((strcol(1) eq 'e') && (strcol(2) eq 'euler_step' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 notitle w points ls 7;
