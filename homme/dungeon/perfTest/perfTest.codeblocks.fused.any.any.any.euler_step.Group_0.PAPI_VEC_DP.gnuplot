...
# Mean rate
set label "" at first X_LIMIT*1./FACTOR, second 744.83 point pt 3 ps 2 lc rgbcolor "#707070";

# Breakpoints
# Unneeded phases separators, nb. breakpoints = 2

# Data accessors to CSV
sampleexcluded(ret,c,r,g,t) = (c eq 'PAPI_VEC_DP' && r eq 'euler_step' && g == 0  && t eq 'e') ? ret : NaN;
sampleunused(ret,c,r,g,t) = (c eq 'PAPI_VEC_DP' && r eq 'euler_step' && g ==  0 && t eq 'un') ? ret : NaN;
sampleused(ret,c,r,g,t) = (c eq 'PAPI_VEC_DP' && r eq 'euler_step' && g == 0 && t eq 'u') ? ret : NaN;
interpolation(ret,c,r,g) = (c eq 'PAPI_VEC_DP' && r eq 'euler_step' && g == 0 ) ? ret : NaN;
slope(ret,c,r,g) = (c eq 'PAPI_VEC_DP' && r eq 'euler_step' && g == 0 ) ? ret : NaN;
