X_LIMIT=292.31 # Do not touch this
...
set obj rect from graph 0.000*FACTOR, graph 0 to graph 0.031*FACTOR, graph 1 fs transparent solid 0.33 noborder fc rgbcolor '#ff0000' behind # Routine: End 3.080%
set obj rect from graph 0.031*FACTOR, graph 0 to graph 1.000*FACTOR, graph 1 fs transparent solid 0.33 noborder fc rgbcolor '#00ff00' behind # Routine: __kmp_ap..arallel_ [__kmp_api_omp_in_parallel_] 96.920%

# Summary for routine __kmp_ap..arallel_ [__kmp_api_omp_in_parallel_] 96.920%

set label center "__kmp_ap..arallel_ [__kmp_api_omp_in_parallel_]\n[551]" at second 0.515*FACTOR, graph 0.5 rotate by 90 tc rgbcolor 'black' front
