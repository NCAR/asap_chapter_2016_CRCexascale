...
set border 1
set xlabel "Time (ms)";
set title "Instance groups for Appl * Task * Thread * - Region Unresolved\n2880 Instances - No instance grouping"
...
set label "" at 292661069.0/1000000.0,0 point lt 1 ps 2 lc rgb "#FF0000";

plot \
'perfTestWACCM.codeblocks.fused.any.any.any.groups.csv' using (strcol(1) eq 'u' && (strcol(2) eq 'Unresolved' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 ti 'Group_0 (2291/589)' w points ls 1,\
'perfTestWACCM.codeblocks.fused.any.any.any.groups.csv' using ((strcol(1) eq 'e') && (strcol(2) eq 'Unresolved' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 notitle w points ls 7;
