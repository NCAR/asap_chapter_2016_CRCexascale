...
set label "" at 15936833.0/1000000.0,0 point lt 1 ps 2 lc rgb "#FF0000";

plot \
'perfTest.codeblocks.fused.any.any.any.groups.csv' using (strcol(1) eq 'u' && (strcol(2) eq 'Unresolved' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 ti 'Group_0 (1948/932)' w points ls 1,\
'perfTest.codeblocks.fused.any.any.any.groups.csv' using ((strcol(1) eq 'e') && (strcol(2) eq 'Unresolved' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 notitle w points ls 7;
