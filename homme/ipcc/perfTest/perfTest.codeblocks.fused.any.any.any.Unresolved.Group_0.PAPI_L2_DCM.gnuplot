...
# Mean rate
set label "" at first X_LIMIT*1./FACTOR, second 23.23 point pt 3 ps 2 lc rgbcolor "#707070";
...
'perfTest.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleexcluded($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Excluded samples (608)' axes x2y1 w points pt 3 lc rgbcolor '#A0A0A0',\
'perfTest.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleunused($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Unused samples (36)' axes x2y1 w points pt 3 lc rgbcolor '#FFA0A0',\
