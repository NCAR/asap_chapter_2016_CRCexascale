...
# Mean rate
set label "" at first X_LIMIT*1./FACTOR, second 0.38 point pt 3 ps 2 lc rgbcolor "#707070";
...
'perfTest.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleexcluded($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Excluded samples (829)' axes x2y1 w points pt 3 lc rgbcolor '#A0A0A0',\
'perfTest.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleused($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Used samples (1325)' axes x2y1 w points pt 3 lc rgbcolor '#FF0000',\
